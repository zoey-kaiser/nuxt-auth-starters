...
// export list of RefreshUserData (array of it, not dictionary)
export const DEMO_USERS_REFRESH: RefreshUserData[] = [
  {
    id: '198372',
    refreshToken: 'someRandomString1'
  },
  {
    id: '22337',
    refreshToken: 'someRandomString2'
  }
]
